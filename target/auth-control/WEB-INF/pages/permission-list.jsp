	                    ...
	                    <tr>
                            ...
                            <td>
                                <shiro:hasPermission name="perm:update">
                                    <a class="glyphicon glyphicon-pencil show-perminfo-form" aria-hidden="true" title="修改权限信息" href="javascript:void(0);" data-toggle="modal" data-target="#perm-form-div"></a>
                                </shiro:hasPermission>
                                <shiro:hasPermission name="perm:delete">
                                    <a class="glyphicon glyphicon-remove delete-this-perm" aria-hidden="true" title="删除权限" href="javascript:void(0);"></a>
                                </shiro:hasPermission>
                            </td>
	                    </tr>
                    </c:forEach>
